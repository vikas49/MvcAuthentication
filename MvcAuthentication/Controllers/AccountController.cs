...
namespace MvcAuthentication.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public ActionResult Registration(RegistrationView registrationView)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (!string.IsNullOrEmpty(userName))
                {
                    ...
                    ViewBag.Message = @"Warning Email, Sorry: Email already Exists";
        ...
        public void VerificationEmail(string email, string activationCode)
        {
            ...
            var fromEmail = new MailAddress("YOUR EMAIL ID HERE", "Activation Account");
            var toEmail = new MailAddress(email);

            var fromEmailPassword = "YOUR EMAIL PASSWORD HERE";
